...
var salita = function salita(dir, options) {
  ...
  return Promise.resolve(jsonFilePlus(filename)).then(loadNPM).then(createFoundPackageJsonLogger(opts)).then(createPromiseAllPromises(opts)).then(createCountAndSave(opts));
};
